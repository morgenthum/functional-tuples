...
public class Tuple5<T1, T2, T3, T4, T5> implements Value5<T1, T2, T3, T4, T5> {
    ...
    public <T6> Tuple6<T1, T2, T3, T4, T5, T6> add(T6 value6) {
    ...
    public <R, E extends Exception> Tuple5<R, T2, T3, T4, T5> map1(Function1<T1, R, E> function) throws E {
        ...
        return Tuple.of(result, value2, value3, value4, value5);
    }
    ...
    public <R, E extends Exception> Tuple5<T1, R, T3, T4, T5> map2(Function1<T2, R, E> function) throws E {
        ...
        return Tuple.of(value1, result, value3, value4, value5);
    }
    ...
    public <R, E extends Exception> Tuple5<T1, T2, R, T4, T5> map3(Function1<T3, R, E> function) throws E {
        ...
        return Tuple.of(value1, value2, result, value4, value5);
    }
    ...
    public <R, E extends Exception> Tuple5<T1, T2, T3, R, T5> map4(Function1<T4, R, E> function) throws E {
        ...
        return Tuple.of(value1, value2, value3, result, value5);
    }
    ...
    public <R, E extends Exception> Tuple5<T1, T2, T3, T4, R> map5(Function1<T5, R, E> function) throws E {
        ...
        return Tuple.of(value1, value2, value3, value4, result);
    }
    ...
    public <E extends Exception> void ifPresent(Consumer5<T1, T2, T3, T4, T5, E> consumer) throws E {
        ifPredicate(Value5::isPresent, consumer);
    }

    public <E extends Exception> void ifPartiallyPresent(Consumer5<T1, T2, T3, T4, T5, E> consumer) throws E {
        ifPredicate(Value2::isPartiallyPresent, consumer);
    }

    public <E extends Exception> void ifPredicate(Predicate<Tuple5<T1, T2, T3, T4, T5>> predicate,
