...
public class Tuple3<T1, T2, T3> implements Value3<T1, T2, T3> {
    ...
    public <T4> Tuple4<T1, T2, T3, T4> add(T4 value4) {
    ...
    public <R, E extends Exception> Tuple3<R, T2, T3> map1(Function1<T1, R, E> function) throws E {
        ...
        return Tuple.of(result, value2, value3);
    }
    ...
    public <R, E extends Exception> Tuple3<T1, R, T3> map2(Function1<T2, R, E> function) throws E {
        ...
        return Tuple.of(value1, result, value3);
    }
    ...
    public <R, E extends Exception> Tuple3<T1, T2, R> map3(Function1<T3, R, E> function) throws E {
        ...
        return Tuple.of(value1, value2, result);
    }
    ...
    public <E extends Exception> void ifPresent(Consumer3<T1, T2, T3, E> consumer) throws E {
        ifPredicate(Value3::isPresent, consumer);
    }

    public <E extends Exception> void ifPartiallyPresent(Consumer3<T1, T2, T3, E> consumer) throws E {
        ifPredicate(Value2::isPartiallyPresent, consumer);
    }

    public <E extends Exception> void ifPredicate(Predicate<Tuple3<T1, T2, T3>> predicate, Consumer3<T1, T2, T3, E> consumer) throws E {
